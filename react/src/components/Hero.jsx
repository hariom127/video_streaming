  ...
  return (
    <section class="text-gray-400 body-font">
      <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
        <img
          class="h-96 mb-10 object-cover object-center rounded"
          alt="hero"
          src={heroImg}
        />
          ...
          <div class="flex w-full justify-center items-end">
            <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
              ...
              <input
                ...
                id="hero-field"
                name="hero-field"
                class="w-full bg-gray-100 bg-opacity-50 rounded focus:ring-2 focus:to-hRed focus:bg-transparent border border-red focus:to-red text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
